...
class M_report_mutasi extends Parent_Model { 
    
	public function __construct(){
			parent::__construct();
			$this->load->database();
	}
	public function fetch_report_mutasi(){
				$sql = "select a.*,b.kode_barang,b.nama_barang,c.kode_ruangan,c.nama_ruangan from t_report_mutasi a 
			...
			{  
					...
					$sub_array[] = $row->tgl_report_mutasi;   
